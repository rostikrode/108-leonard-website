...
export default class PressArticle extends Component {
  constructor(props) {
    super(props);
    this.state = {
      article: this.slugify(
        this.props.match ? this.props.match.params.article : ''
      ),
      publication: this.slugify(
        this.props.match ? this.props.match.params.publication : ''
      ),
      entry: {},
      overflow: '',
  ...
  render() {
    ...
    if (this.props.pressArticles) {
      article = this.props.pressArticles.find(article => {
        ...
        if (
          artslug === this.state.article &&
          pubslug === this.state.publication
        ) {
          return article;
        }
      });
    ...
    if (article) {
      ...
      return (
        ...
        >
          ...
          >
            ...
            <a className="url serif-bold upper" href={pdf} target="_blank">
      ...
      return <div className="press-article" />;
    }
  }
}
